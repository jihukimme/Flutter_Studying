...
import 'package:test_project/view/UI/page/home_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(//바텀 네비게이션 바
            items: const [
